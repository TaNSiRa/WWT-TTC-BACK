...
router.post('/WWT/getJobDetail', async (req, res) => {
  ...
  let query = `SELECT I.*, R.ItemStatus
               ...
               ORDER BY I.ListJobDate, I.BottleCode, I.AnalysisDue;`;
  // console.log(query);
  let db = await mssql.qurey(query);
  // console.log(db);
  if (db["recordsets"].length > 0) {
...
router.post('/WWT/TempSaveOil', async (req, res) => {
  console.log("--TempSaveOil--");
  ...
  try {
    ...
    for (const data of dataRow) {
      ...
      pushField("STD_W2_1", data.STD_W2_1);
      pushField("STD_W2_2", data.STD_W2_2);
      ...
      pushField("LFB1_W2_1", data.LFB1_W2_1);
      pushField("LFB1_W2_2", data.LFB1_W2_2);
      pushField("LFB1_W2_Diff", data.LFB1_W2_Diff);
      ...
      pushField("LFB2_W2_1", data.LFB2_W2_1);
      pushField("LFB2_W2_2", data.LFB2_W2_2);
      pushField("LFB2_W2_Diff", data.LFB2_W2_Diff);
      pushField("LFB2_W2_W1", data.LFB2_W2_W1);
      pushField("LFB2_Cal", data.LFB2_Cal);
      pushField("LFB2_Recovery", data.LFB2_Recovery);
      pushField("LFB_Avg", data.LFB_Avg);
      pushField("LFB_RPD", data.LFB_RPD);
      pushField("No", data.No);
      pushField("Sample_Use", data.Sample_Use);
      pushField("W1_1", data.W1_1);
      pushField("W1_2", data.W1_2);
      pushField("W1_Diff", data.W1_Diff);
      pushField("W2_1", data.W2_1);
      pushField("W2_2", data.W2_2);
...
router.post('/WWT/TempSaveColor', async (req, res) => {
  console.log("--TempSaveColor--");
  ...
  try {
    ...
    for (const data of dataRow) {
      ...
      pushField("CCS1_1", data.CCS1_1);
      pushField("CCS1_Recovery", data.CCS1_Recovery);
      pushField("CVS1_1", data.CVS1_1);
      pushField("CVS1_Recovery", data.CVS1_Recovery);
      pushField("R2", data.R2);
      pushField("Original_pH", data.Original_pH);
      pushField("Original_1", data.Original_1);
      ...
      pushField("pH_RPD", data.pH_RPD);
      pushField("CCS2_1", data.CCS2_1);
...
router.post('/WWT/TempSaveEC', async (req, res) => {
  console.log("--TempSaveEC--");
  ...
  try {
    ...
    for (const data of dataRow) {
      ...
      pushField("QCS_EC_1", data.QCS_EC_1);
      pushField("QCS_EC_2", data.QCS_EC_2);
      pushField("QCS_Avg", data.QCS_Avg);
      pushField("QCS_RPD", data.QCS_RPD);
      pushField("EC_1", data.EC_1);
...
router.post('/WWT/TempSaveTEMP', async (req, res) => {
  console.log("--TempSaveTEMP--");
...
router.post('/WWT/TempSaveIC', async (req, res) => {
  console.log("--TempSaveIC--");
  ...
  try {
    ...
    for (const data of dataRow) {
      ...
      pushField("QCS_DilutionTime", data.QCS_DilutionTime);
      pushField("QCS_Cl_1", data.QCS_Cl_1);
      pushField("QCS_Cl_2", data.QCS_Cl_2);
      pushField("QCS_Cl_Cal", data.QCS_Cl_Cal);
      pushField("QCS_RPD", data.QCS_RPD);
      pushField("QCS_Recovery", data.QCS_Recovery);
      pushField("R2", data.R2);
      pushField("DilutionTime", data.DilutionTime);
      pushField("Cl_1", data.Cl_1);
...
router.post('/WWT/TempSaveCN', async (req, res) => {
  console.log("--TempSaveCN--");
  ...
  try {
    ...
    for (const data of dataRow) {
      ...
      pushField("Spk", data.Spk);
      pushField("CCV_1_Absorbance", data.CCV_1_Absorbance);
      pushField("CCV_1_RawData", data.CCV_1_RawData);
      pushField("CCV_1_Cal", data.CCV_1_Cal);
      pushField("CCV_1_Recovery", data.CCV_1_Recovery);
      pushField("CCV_2_Absorbance", data.CCV_2_Absorbance);
      pushField("CCV_2_RawData", data.CCV_2_RawData);
      pushField("CCV_2_Cal", data.CCV_2_Cal);
      pushField("CCV_2_Recovery", data.CCV_2_Recovery);
      pushField("R2", data.R2);
      pushField("Slope", data.Slope);
      pushField("MB_Distillation", data.MB_Distillation);
      pushField("MB_Colormetric", data.MB_Colormetric);
      pushField("MB_Dilution", data.MB_Dilution);
      pushField("MB_Absorbance", data.MB_Absorbance);
      pushField("MB_RawData", data.MB_RawData);
      pushField("MB_Cal", data.MB_Cal);
      pushField("LFB_Distillation", data.LFB_Distillation);
      pushField("LFB_Colormetric", data.LFB_Colormetric);
      pushField("LFB_Dilution", data.LFB_Dilution);
      pushField("LFB_Absorbance", data.LFB_Absorbance);
      pushField("LFB_RawData", data.LFB_RawData);
      pushField("LFB_Cal", data.LFB_Cal);
      pushField("LFB_Recovery", data.LFB_Recovery);
      pushField("LFM1_Distillation", data.LFM1_Distillation);
      pushField("LFM1_Colormetric", data.LFM1_Colormetric);
      pushField("LFM1_Dilution", data.LFM1_Dilution);
      pushField("LFM1_Absorbance", data.LFM1_Absorbance);
      pushField("LFM1_RawData", data.LFM1_RawData);
      pushField("LFM1_Cal", data.LFM1_Cal);
      pushField("LFM1_Recovery", data.LFM1_Recovery);
      pushField("LFM2_Distillation", data.LFM2_Distillation);
      pushField("LFM2_Colormetric", data.LFM2_Colormetric);
      pushField("LFM2_Dilution", data.LFM2_Dilution);
      pushField("LFM2_Absorbance", data.LFM2_Absorbance);
      pushField("LFM2_RawData", data.LFM2_RawData);
      pushField("LFM2_Cal", data.LFM2_Cal);
      pushField("LFM2_Recovery", data.LFM2_Recovery);
      pushField("LFM_RPD", data.LFM_RPD);
      pushField("Distillation_1", data.Distillation_1);
      pushField("Colormetric_1", data.Colormetric_1);
      pushField("Dilution_1", data.Dilution_1);
      pushField("Absorbance_1", data.Absorbance_1);
      pushField("RawData_1", data.RawData_1);
      pushField("Cal_1", data.Cal_1);
      pushField("Distillation_2", data.Distillation_2);
      pushField("Colormetric_2", data.Colormetric_2);
      pushField("Dilution_2", data.Dilution_2);
      pushField("Absorbance_2", data.Absorbance_2);
      pushField("RawData_2", data.RawData_2);
      pushField("Cal_2", data.Cal_2);
      pushField("Avg", data.Avg);
      pushField("RPD", data.RPD);
      pushField("Remark_Job", data.REMARKJOB);
...
router.post('/WWT/SaveOil', async (req, res) => {
  console.log("--SaveOil--");
...
router.post('/WWT/SaveColor', async (req, res) => {
...
router.post('/WWT/SaveEC', async (req, res) => {
  console.log("--SaveEC--");
...
router.post('/WWT/SaveTEMP', async (req, res) => {
...
router.post('/WWT/SaveIC', async (req, res) => {
  console.log("--SaveIC--");
...
router.post('/WWT/SaveCN', async (req, res) => {
  console.log("--SaveCN--");
...
router.post('/WWT/approveRejectOil', async (req, res) => {
  console.log("--approveRejectOil--");
  console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
    ...
    for (const data of dataRow) {
      ...
      if (data.DECISIONUSER !== '') {
        ...
        pushField("JobStatus", 'COMPLETE');
        if (itemStatus === 'FINISH ITEM') {
          pushField("Result_1", data.Cal);
          pushField("ResultApprove", data.Cal);
        } else if (itemStatus === 'FINISH RECHECK') {
          pushField("Result_2", data.Cal);
          pushField("ResultApprove", data.Cal);
        }
...
router.post('/WWT/approveRejectColor', async (req, res) => {
  console.log("--approveRejectColor--");
  // console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
    ...
    for (const data of dataRow) {
      ...
      const originalValue =
        data.Original_Avg && data.Original_Avg !== ''
          ? data.Original_Avg
          : data.Original_1;

      const pHValue =
        data.pH_Avg && data.pH_Avg !== ''
          ? data.pH_Avg
          : data.pH_1;
      ...
      if (data.DECISIONUSER !== '') {
        ...
        if (originalValue !== '' && pHValue !== '') {
          ...
          if (itemStatus === 'FINISH ITEM') {
            ...
            pushField("Result_2", resultText);
          }
          pushField("ResultApprove", resultText);
        }
...
router.post('/WWT/approveRejectEC', async (req, res) => {
  console.log("--approveRejectEC--");
  // console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
    ...
    for (const data of dataRow) {
      ...
      if (data.DECISIONUSER !== '') {
        ...
        if (result !== '') {
          if (itemStatus === 'FINISH ITEM') {
            pushField("Result_1", result);
          } else if (itemStatus === 'FINISH RECHECK') {
            pushField("Result_2", result);
          }
          pushField("ResultApprove", result);
        }
...
router.post('/WWT/approveRejectTEMP', async (req, res) => {
  console.log("--approveRejectTEMP--");
  // console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
...
router.post('/WWT/approveRejectIC', async (req, res) => {
  console.log("--approveRejectIC--");
  // console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
    ...
    for (const data of dataRow) {
      ...
      if (data.DECISIONUSER !== '') {
        ...
        pushField("JobStatus", 'COMPLETE');
        if (itemStatus === 'FINISH ITEM') {
          pushField("Result_1", data.Cl_Cal);
        } else if (itemStatus === 'FINISH RECHECK') {
          pushField("Result_2", data.Cl_Cal);
        }
        pushField("ResultApprove", data.Cl_Cal);
...
router.post('/WWT/approveRejectCN', async (req, res) => {
  console.log("--approveRejectCN--");
  // console.log(req.body);
  try {
    let dataRow = JSON.parse(req.body.dataRow);
    const now = ISOToLocal(new Date());
...
router.post('/WWT/ItemByDueDate', async (req, res) => {
  ...
  let query = `SELECT 
    ...
    COUNT(CASE WHEN ItemStatus IN ('FINISH ITEM', 'FINISH RECHECK') THEN 1 END) AS WAITAPPROVEJOB,
